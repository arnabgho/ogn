#ifndef OGN_COLOR_DATA_LAYER_HPP_
#define OGN_COLOR_DATA_LAYER_HPP_
...
class OGNColorDataLayer : public OGNLayer<Dtype> {
 public:
  explicit OGNColorDataLayer(const LayerParameter& param)
 ...
 private:
   ...
   std::vector<ColorOctree> _octrees;
   std::vector<ColorOctree> _batch_octrees;
...
#endif  // OGN_COLOR_DATA_LAYER_HPP_
